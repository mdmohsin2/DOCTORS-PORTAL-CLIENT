    ...
    return (
        <div className='flex justify-center items-center mt-28'>
            <div className='w-96 bg-gray-800 rounded-md p-7'>
                <h2 className='text-3xl text-white text-center'>Add A Doctor</h2>
                <div>
                    <form onSubmit={handleSubmit(handleAddDoctor)}>
                        ...
                        <div className="form-control w-full max-w-xs my-3">
                            ...
                            <select
                            {...register('specialty')}
                            className="select select-bordered border-info w-full max-w-xs">
                                {
                                    specialties &&
                        ...
                        <input type="submit" value="Add Doctor" className='btn bg-gray-600 w-full' />
